...
// Tạo Table để chứa dữ liệu
        try {
            String sql = "CREATE TABLE tbllop(mssv TEXT primary key,hoten TEXT, lop TEXT)";
        ...
        btndelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String malop = edtmssv.getText().toString();
        ...
        btnupdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ContentValues myvalue = new ContentValues();
                myvalue.put("lop",lop);
                int n = mydatabase.update("tbllop",myvalue,"mssv = ?",new String[]{mssv});
                String msg = "";
                if (n == 0)
                {
